...
""" 
        for degree in range(88,48,-1): #down 10 up 0
                print(degree)
        servo2.angle = int(degree)
        for degree in range(90,130,+1): # up 10
            print(degree)
        servo8.angle = int(degree)

        for degree in range(90,50,-1): # down 0 10 up
            print(degree)
        servo5.angle = int(degree)

        for degree in range(95,135,+1): #10dowun
            print(degree)
        servo11.angle = int(degree)
        time.sleep(2)
        for degree in range(48,88,+1): #down 10 up 0
                print(degree)
        servo2.angle = int(degree)
        for degree in range(130,90,-1): # up 10
            print(degree)
        servo8.angle = int(degree)

        for degree in range(50,90,+1): # down 0 10 up
            print(degree)
        servo5.angle = int(degree)

        for degree in range(135,95,-1): #10dowun
            print(degree)
        servo11.angle = int(degree)
        time.sleep(2)
 """
