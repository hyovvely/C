...
while True:
    ...
    for degree in range(100): # +10
            print(degree)
    servo8.angle = int(degree)
    for degree in range(50):#-20
            print(degree)
    servo6.angle = int(degree)
    ...
    for degree in range(80): #-10
            print(degree)
    servo5.angle = int(degree)
    for degree in range(140): #+20
            print(degree)
    servo3.angle = int(degree)
    ...
    for degree in range(140):#-30
            print(degree)
    servo7.angle = int(degree)
    for degree in range(50): # +30
            print(degree)
    servo4.angle = int(degree)
    ...
    for degree in range(80):#+10
            print(degree)
    servo6.angle = int(degree)
    for degree in range(110): # -10
            print(degree)
    servo3.angle = int(degree)
    for degree in range(100):# 10 up
            print(degree)
    servo9.angle = int(degree)
    for degree in range(70): #10 back
            print(degree)
    servo0.angle = int(degree)
    ...
    for degree in range(120): # +10
            print(degree)
    servo3.angle = int(degree)
    for degree in range(70):#-10
            print(degree)
    servo6.angle = int(degree)
