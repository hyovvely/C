...
for(angle2 = 55; angle2 < 60; angle2++){//위에 고정하는 각도//6오뒤위2 7왼앞위8
  ...
  for(angle2 = 60; angle2 > 55; angle2--){
 ...
 for(angle2 = 130; angle2 < 135; angle2++){//오앞위 5
    h8.write(angle2);
    
  }
  for(angle2 = 135; angle2 > 130; angle2--){
    h8.write(angle2);
