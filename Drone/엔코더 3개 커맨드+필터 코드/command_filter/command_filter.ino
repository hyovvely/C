...
if(command.equals("asd")){Serial.print(" "); Serial.println(averagex);}
if(command.equals("qwe")){Serial.print(" ");Serial.println(averagey);}
else if (command.equals("zxc")){Serial.print(" ");Serial.println(averagez);}
}
